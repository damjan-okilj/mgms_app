...
class CalendarNewTask extends StatefulWidget {
  CalendarNewTask({super.key, required this.date, required this.users});
  DateTime date;
  List<User> users = [];
  @override
  State<CalendarNewTask> createState() => _CalendarNewTaskState();
...
class _CalendarNewTaskState extends State<CalendarNewTask> {
            ...
            showCupertinoDialog(
                ...
                builder: (context) {
                  return CupertinoAlertDialog(
                    title:
                        const Text("Are you sure you want to create new task"),
                    actions: [
